...
import './BodyDonation.css';

const BodyDonation = () => {
  return (
    <div className="body-donation">
      <h1>What is Body Donation?</h1>
      <p>
        Body Donation, also called Deh Dan, is the donation of the whole body after death for the purpose of medical research and education. Body Donation is important for helping medical students and researchers to understand the human body, and for the advancement of science. 
      ...
      <h2>Are there any limitations or conditions on Body Donation?</h2>
      <p>
        Though most institutions welcome the offer of a donation, there are certain medical conditions that may lead to the offer being declined. Medical Colleges can give you more information about these conditions and any other reasons why a Body Donation may be declined.
      </p>
      <p>
      ...
      <h2>How do I donate my Body?</h2>
      <p>
        You need to identify and get in touch with Medical Colleges or Body Donation NGOs near you in order to register your wish to donate your body after death in your city.
      </p>
      <p>
        You can obtain this information by clicking on the above green button (Pan-India Body Donation Directory) and finding a Healthcare Institution or organization in India near you.
      </p>
      <p>
        The most important thing that you need to know is that, after your death, it is your family or next of kin who will carry out the process of donating your body. Therefore, it’s very important that they are involved in your decision, aware of your wishes, and are comfortable carrying out the entire process. Their support is of paramount importance.
      </p>
    </div>
  );
};
